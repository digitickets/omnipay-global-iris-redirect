...
namespace Omnipay\GlobalIris\Test\Gateway;

use Omnipay\GlobalIris\Gateway;
use Omnipay\GlobalIris\Message\RedirectPurchaseRequest;
use Omnipay\GlobalIris\Message\RedirectPurchaseResponse;

use Omnipay\Tests\GatewayTestCase;

class GlobalIrisTest extends GatewayTestCase
{
    /**
     * @var \Omnipay\GlobalIris\Gateway
     */
    protected $gateway;
